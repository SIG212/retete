  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 w-full max-w-sm">
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">Rețetele mele</h1>
        <p className="text-gray-500 text-sm mb-6">Salvează și organizează rețetele tale favorite.</p>
        <button
          onClick={handleLogin}
